  ...
  return (
    <div className="grid grid-cols-1 gap-4 px-4 lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      <Card className="@container/card bg-black/20 backdrop-blur-lg border-purple-500/20 shadow-xl hover:shadow-purple-500/20 transition-all duration-300">
        <CardHeader>
          <CardDescription className="text-purple-200/80">Profile Views</CardDescription>
      ...
      <Card className="@container/card bg-black/20 backdrop-blur-lg border-purple-500/20 shadow-xl hover:shadow-purple-500/20 transition-all duration-300">
        <CardHeader>
          <CardDescription className="text-purple-200/80">Total Commits</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl text-white">
            2,847
          </CardTitle>
          <CardAction>
      ...
      <Card className="@container/card bg-black/20 backdrop-blur-lg border-purple-500/20 shadow-xl hover:shadow-purple-500/20 transition-all duration-300">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-purple-200/60">This year&apos;s contributions</div>
        </CardFooter>
      </Card>
      <Card className="@container/card bg-black/20 backdrop-blur-lg border-purple-500/20 shadow-xl hover:shadow-purple-500/20 transition-all duration-300">
        <CardHeader>
          <CardDescription className="text-purple-200/80">Total PRs</CardDescription>
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl text-white">
            127
          </CardTitle>
          <CardAction>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium text-green-300">
            Active collaboration this month <IconTrendingUp className="size-4" />
          </div>
